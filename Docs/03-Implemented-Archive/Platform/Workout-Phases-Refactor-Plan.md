> **Status:** `ARCHIVED` — **IMPLEMENTED** June 2026; not current product truth.
> **As-built:** `WorkoutPhase` / `WorkoutTemplatePhase` in Prisma; `GET/POST /workout-phases`; Admin `WorkoutEditor` + `/admin/workout-phases`; mobile sync exports `phases[]` + flat `exercises[]`.
> **Archived:** 2026-06-22

# Workout Template Refactor — Phases, Components & 2-Pane Editor

> **Status:** ✅ IMPLEMENTED · **Date:** 2026-06-07 (plan) · **Implemented:** 2026-06 · **Owner:** Mahmoud
