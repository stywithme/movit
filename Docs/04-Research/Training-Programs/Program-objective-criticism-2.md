...
هذه توسعات تصميمية منطقية للمنتج، وليست استنتاجات مباشرة من ACSM نفسها. هذا ليس خطأ، لكنه يجب أن يُذكر صراحةً حتى لا تبدو الوثيقة وكأنها تستند إلى ACSM في مناطق هي في الحقيقة اجتهاد POSEي جيد، لا أكثر.
...
وسم ما هو ACSM-backed وما هو POSE design extension
