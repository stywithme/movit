...
| **As-built** | [Metrics-As-Built.md](../../00-Active-Reference/Metrics/Metrics-As-Built.md) |
| **Verified** | 2026-06-22 |

# Metrics — Improvement Roadmap (علمي + backlog)

> **للوضع الفعلي في الكود:** [Metrics-As-Built.md](../../00-Active-Reference/Metrics/Metrics-As-Built.md)  
> **للتعريفات التفصيلية:** [Metrics-Complete-Reference.md](../../00-Active-Reference/Metrics/Metrics-Complete-Reference.md)

بناءً على المراجعة العلمية لمقاييس الأداء البدني + تحليل المشروع. **لا تُستخدم كمواصفة تنفيذ** دون التحقق من As-Built.

---

## Implementation status (vs code, 2026-06-22)
...
| Velocity loss (engine) | **IMPLEMENTED** — not synced to backend |
| TUT = Σ rep durations | **IMPLEMENTED** |
| Tempo consistency (engine) | **IMPLEMENTED** — not synced to backend |
| V2 composite Safety/Control/Overall | **IMPLEMENTED** (report JSON) |
| V2 Form/Safety/Control cards in UI | **PARTIAL** — `ReportDetailScreen` has 4 tabs, no metric cards |
| ROM Achievement % vs target pose | **PLANNED** |
| CoM-based stability | **PLANNED** |
| PositionCheck-based alignment (single SSOT) | **PLANNED** |
| Movement smoothness (jerk) | **PLANNED** |
| Sync `velocityLoss` + `tempoConsistency` to Prisma | **PLANNED** |

التفاصيل والمسارات: [Metrics-As-Built.md](../../00-Active-Reference/Metrics/Metrics-As-Built.md).
