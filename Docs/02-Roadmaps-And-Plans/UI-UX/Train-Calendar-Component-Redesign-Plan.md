...
>
> النطاق: المكوّن الأسبوعي (`MovitWeekStrip` / `TrainWeekPreview`) في أعلى شاشة **Train** بتطبيق `kmp-app` (KMP).
...
**ملف المنطق:** [`TrainApiMapper.buildWeekPreview`](../../../kmp-app/feature/train/src/commonMain/kotlin/com/movit/feature/train/TrainApiMapper.kt) (الأسطر ~227–260):
...
**ملف:** [`MovitWeekStrip.kt`](../../../kmp-app/core/designsystem/src/commonMain/kotlin/com/movit/designsystem/components/MovitWeekStrip.kt)
...
**ملف DTO:** [`HomeDto.kt`](../../../kmp-app/core/network/src/commonMain/kotlin/com/movit/core/network/dto/HomeDto.kt)
...
### 5.6 الاختبارات
- اختبارات mapper لكل حالة في §4.2، خصوصاً: **إنجاز غير متّصل**، **راحة بين أيام تدريب**، **يوم متعدّد الجلسات جزئي**، **catch-up snap**، **أسبوع بعدد أيام ≠ 7**. (توسيع [`MovitTrainStateTest.kt`](../../../kmp-app/feature/train/src/commonTest/kotlin/com/movit/feature/train/MovitTrainStateTest.kt) و [`TrainApiMapperTest.kt`](../../../kmp-app/feature/train/src/commonTest/kotlin/com/movit/feature/train/TrainApiMapperTest.kt)).
...
| **DTO** | `WeekCalendarDto/DayDto/WorkoutDto` + حقل في `TrainModeDto` ([`HomeDto.kt`](../../../kmp-app/core/network/src/commonMain/kotlin/com/movit/core/network/dto/HomeDto.kt)) | ✅ Android + **iOS** أخضر |
| **Models** | `TrainWeekDayState` صادق (حذف `Missed`) + `TrainWeekDayUi`/`TrainWeekDayDetailUi` | ✅ |
| **Mapper** | `buildCurrentWeek`/`buildWeekOptions`/`mapWeekCalendar` تستهلك الـ backend مباشرة؛ fallback صادق بلا تخمين ([`TrainApiMapper.kt`](../../../kmp-app/feature/train/src/commonMain/kotlin/com/movit/feature/train/TrainApiMapper.kt)) | ✅ + اختبار جديد |
| **DS Component** | `MovitWeekStrip` تفاعلي: حالات جديدة، حلقة "اليوم"، شريط تقدّم، نقاط راحة/استشفاء، أحرف أيام، Legend كامل، contentDescription ([`MovitWeekStrip.kt`](../../../kmp-app/core/designsystem/src/commonMain/kotlin/com/movit/designsystem/components/MovitWeekStrip.kt)) | ✅ Android + **iOS** أخضر |
