...
```powershell
rg "^import android\.|^import java\." kmp-app/**/commonMain
rg "Color\(0x|#[0-9A-Fa-f]{6}" kmp-app/feature/**/commonMain
rg "ex-squat-warm|coming soon|Share report|Export report" kmp-app/feature/shell/src/commonMain
```
