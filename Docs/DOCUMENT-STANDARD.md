...
استثناءات: جلسة تسجيل الدخول، `AssessmentSession`.
...
| `EVOLUTION` | قرار هيكلي غيّر المنتج/الكود (سجل تغيير) | `03-Evolution/` |
...
| **Migration / PR** | مسار migration أو PR |
...
قالب كامل: [`03-Evolution/_TEMPLATE.md`](03-Evolution/_TEMPLATE.md).
...
| قرار أزال/غيّر ميزة أو بنية | `03-Evolution/` |

| خطة نُفّذت (وثيقة الخطة نفسها) | `03-Implemented-Archive/` + بانر |

| ورقة/بحث | `04-Research/` |

| مسار قديم / redirect | `98-Redirects/` |
...
| as-built (جدول المواضيع) | [`00-Active-Reference/README.md`](00-Active-Reference/README.md) |

| سجل التغييرات | [`03-Evolution/README.md`](03-Evolution/README.md) |
