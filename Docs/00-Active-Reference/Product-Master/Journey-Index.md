...
| 8 | **Train mode (guided)** | `ProgramSessionActivity` + `SessionTrainingEngine` + خطة أسبوع/يوم | مسار موجّه بالكامل | ✅ |
...
| 10 | **Session training** | `TrainingEngine` + rep/hold + تقارير لكل تمرين | Every Rep Counts + coaching loop | ✅ |
...
| 12 | **Backend session sync** | `POST /mobile/sessions`, `complete` → `SessionMetrics` / `RepMetrics` | نفس الحلقة | ✅ |
...
| Beta / قياس | [14-Beta-Measurement.md](../../01-Business-Planning/14-Beta-Measurement.md), [16-Correct-Session-Definition.md](../../01-Business-Planning/16-Correct-Session-Definition.md) |
