...
|---|---|
| **Status** | `ROADMAP` |
| **SSOT for** | ACSM → Movit integration gaps and build priorities |
| **Research basis** | [`04-Research/ACSM-Prescription/`](../../04-Research/ACSM-Prescription/) |
| **As-built journey** | [`trainee-journey-current-state/`](../Architecture-As-Built/trainee-journey-current-state/) — لا تُكرَّر هنا |
| **Verified** | 2026-06-22 |

# Integration Gap Tracker — ACSM 2026 → Movit

> مبنية على مقارنة مفصّلة بين نتائج الدراسة والحالة الفعلية للكود في `kmp-app` و `backend`.
> للوضع الحالي للمتدرب (onboarding، prescription، progression) راجع [trainee-journey](../Architecture-As-Built/trainee-journey-current-state/README.md) وليس هذا الملف.
---
