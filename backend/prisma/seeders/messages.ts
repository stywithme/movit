...
export async function seedBaseMessageTemplates(ensureMessageTemplate: EnsureMessageTemplate) {
  const baseMessageTemplates: Array<{
    ...
    {
      code: 'phase_spine_top_neutral',
      category: 'state',
      context: 'phase',
      content: { ar: 'ظهر محايد في الوقفة', en: 'Neutral spine at the top' },
      tags: ['phase', 'spine', 'squat'],
    },
    {
      code: 'phase_spine_bottom_flex',
      category: 'state',
      context: 'phase',
      content: { ar: 'انحناء مقبول في القاع مع تحكم', en: 'Acceptable flexion at bottom with control' },
      tags: ['phase', 'spine', 'squat'],
    },
    {
      code: 'phase_hip_top_lockout',
      category: 'state',
      context: 'phase',
      content: { ar: 'وقفة كاملة — ورك ممتد', en: 'Full stand — hips extended' },
      tags: ['phase', 'hip', 'squat'],
    },
    {
      code: 'phase_hip_bottom_depth',
      category: 'state',
      context: 'phase',
      content: { ar: 'عمق جيد بين الوركين', en: 'Good depth between the hips' },
      tags: ['phase', 'hip', 'squat'],
    },
    {
      code: 'phase_shoulder_press_top_lockout',
      category: 'state',
      context: 'phase',
      content: { ar: 'تمدد كامل فوق الرأس', en: 'Full overhead lockout' },
      tags: ['phase', 'shoulder', 'press'],
    },
    {
      code: 'phase_shoulder_press_top_pad',
      category: 'state',
      context: 'phase',
      content: { ar: 'أكمل التمدد قبل العد التالي', en: 'Finish lockout before the next rep' },
      tags: ['phase', 'shoulder', 'press'],
    },
    {
      code: 'phase_shoulder_press_bottom_perfect',
      category: 'state',
      context: 'phase',
      content: { ar: 'مستوى كتف جيد', en: 'Good shoulder-line position' },
      tags: ['phase', 'shoulder', 'press'],
    },
    {
      code: 'phase_shoulder_press_bottom_warning',
      category: 'state',
      context: 'phase',
      content: { ar: 'اقترب لمستوى الكتف بسلاسة', en: 'Lower smoothly to shoulder level' },
      tags: ['phase', 'shoulder', 'press'],
    },
    {
      code: 'phase_knee_hinge_top_perfect',
      category: 'state',
      context: 'phase',
      content: { ar: 'ورك وركبة ممتدان — قفل جيد', en: 'Hip and knee extended — good lockout' },
      tags: ['phase', 'knee', 'hinge'],
    },
    {
      code: 'phase_knee_hinge_top_warning',
      category: 'state',
      context: 'phase',
      content: { ar: 'اضغط لقفل الورك', en: 'Drive hips through to lock out' },
      tags: ['phase', 'knee', 'hinge'],
    },
    {
      code: 'phase_knee_hinge_bottom_perfect',
      category: 'state',
      context: 'phase',
      content: { ar: 'ثني ركبة مناسب في القاع', en: 'Appropriate knee bend at the bottom' },
      tags: ['phase', 'knee', 'hinge'],
    },
    {
      code: 'phase_knee_hinge_bottom_warning',
      category: 'state',
      context: 'phase',
      content: {
        ar: 'اثنِ الركبة قليلاً إن كانت الساقان شبه مفرودتين',
        en: 'Add a little knee bend if legs are too straight',
      },
      tags: ['phase', 'knee', 'hinge'],
    },
  ];
