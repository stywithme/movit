...
export const protectedAdminRoutes: { prefix: string; subject: Subject }[] = [
  ...
  { prefix: '/admin/analytics/users', subject: 'UserAnalytics' },
  { prefix: '/admin/analytics/sessions', subject: 'TrainingAnalytics' },
  { prefix: '/admin/analytics/activation', subject: 'ActivationAnalytics' },
  { prefix: '/admin/analytics/retention', subject: 'EngagementAnalytics' },
  { prefix: '/admin/analytics/training', subject: 'TrainingAnalytics' },
  ...
  { prefix: '/admin/analytics/progression', subject: 'ProgressionAnalytics' },
  { prefix: '/admin/analytics/revenue', subject: 'RevenueAnalytics' },
  { prefix: '/admin/analytics/bookings', subject: 'BookingAnalytics' },
  { prefix: '/admin/analytics/safety', subject: 'SafetyAnalytics' },
  { prefix: '/admin/analytics/content', subject: 'ContentAnalytics' },
  { prefix: '/admin/analytics', subject: 'OverviewAnalytics' },
