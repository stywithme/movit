...
export const protectedAdminRoutes: { prefix: string; subject: Subject }[] = [
  ...
  { prefix: '/admin/analytics/progression', subject: 'ProgressionRule' },
  ...
  { prefix: '/admin/analytics/content', subject: 'Analytics' },
  { prefix: '/admin/analytics/activation', subject: 'Analytics' },
