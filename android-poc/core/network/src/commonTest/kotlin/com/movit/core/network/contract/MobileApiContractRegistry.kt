...
object MobileApiContractRegistry {
    ...
    val deferredEndpoints: List<DeferredEndpoint> = listOf(
        ...
        DeferredEndpoint("POST", "api/assessment", "Assessment upload — parity read backlog"),
        DeferredEndpoint("GET", "api/assessment/latest", "Assessment read backlog"),
        DeferredEndpoint("GET", "api/assessment/progress", "Assessment read backlog"),
        DeferredEndpoint("GET", "api/mobile/assessment-templates/resolve", "Assessment template backlog"),
        DeferredEndpoint("GET", "api/mobile/level-profile/history", "Level history parity"),
        DeferredEndpoint("GET", "api/mobile/level-profile/levels", "Level definitions parity"),
        ...
        DeferredEndpoint("GET", "api/mobile/plan/today", "Today plan read parity"),
        ...
        DeferredEndpoint("GET", "api/mobile/progression/history", "Progression read parity"),
        DeferredEndpoint("GET", "api/mobile/progression/recent", "Progression read parity"),
        DeferredEndpoint("GET", "api/mobile/progression/session/{sessionId}", "Progression read parity"),
        ...
        DeferredEndpoint("GET", "api/mobile/programs/{id}/preview", "Program preview read parity"),
        DeferredEndpoint("GET", "api/mobile/training-profile", "Training profile GET (PUT covered)"),
    )
