...
/**
 * SessionRunState - Represents the current state of a single-exercise workout run
 * 
 * This is the Single Source of Truth for run lifecycle, managed by SessionSupervisor.
 * 
 * State Flow:
