...
object BodyPostureDetector {
    ...
    fun detect(landmarks: List<Landmark>): PostureResult {
        ...
        val absAngle = abs(atan2(dy.toDouble(), dx.toDouble()) * (180.0 / PI)).toFloat()
    ...
    private fun checkSitting(
        ...
        val lHip = landmarks[PoseLandmarkIndices.LEFT_HIP]
        val rHip = landmarks[PoseLandmarkIndices.RIGHT_HIP]
        val lAnkle = landmarks[PoseLandmarkIndices.LEFT_ANKLE]
        val rAnkle = landmarks[PoseLandmarkIndices.RIGHT_ANKLE]
    ...
    private fun classifyLyingType(
        ...
        val nose = landmarks.getOrNull(PoseLandmarkIndices.NOSE)
