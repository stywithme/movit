...
object VisibleRegionDetector {
    ...
    private val UPPER_INDICES = intArrayOf(
        ...
        PoseLandmarkIndices.LEFT_ELBOW, PoseLandmarkIndices.RIGHT_ELBOW,
        PoseLandmarkIndices.LEFT_WRIST, PoseLandmarkIndices.RIGHT_WRIST,
    )
    ...
    private val LOWER_INDICES = intArrayOf(
        ...
        PoseLandmarkIndices.LEFT_ANKLE, PoseLandmarkIndices.RIGHT_ANKLE,
        PoseLandmarkIndices.LEFT_HEEL, PoseLandmarkIndices.RIGHT_HEEL,
    )
    ...
    fun detect(landmarks: List<Landmark>): RegionResult {
     ...
     */
    private fun avgPresence(landmarks: List<Landmark>, indices: IntArray): Float {
        var sum = 0f
        var count = 0
        for (i in indices) {
