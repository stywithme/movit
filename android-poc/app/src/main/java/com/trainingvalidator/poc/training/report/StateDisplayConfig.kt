...
object JointNameHelper {
    ...
    private val JOINT_NAMES = mapOf(
        ...
        "left_shoulder_cross" to LocalizedText(ar = "الكتف الأيسر (تقاطع)", en = "Left Shoulder Cross"),
        "right_shoulder_cross" to LocalizedText(ar = "الكتف الأيمن (تقاطع)", en = "Right Shoulder Cross"),
        "left_hip_cross" to LocalizedText(ar = "الورك الأيسر (تقاطع)", en = "Left Hip Cross"),
        "right_hip_cross" to LocalizedText(ar = "الورك الأيمن (تقاطع)", en = "Right Hip Cross"),
